...
" Base colors.
" background 234
let s:colors.base0 = { 'gui': '#0c1014', 'cterm': 230 }
" column highlighting 235
let s:colors.base1 = { 'gui': '#11151c', 'cterm': 251 }
" statusbar 238
let s:colors.base2 = { 'gui': '#091f2e', 'cterm': 245 }
" visual select 236
let s:colors.base3 = { 'gui': '#0a3749', 'cterm': 229  }
" comments 240
let s:colors.base4 = { 'gui': '#245361', 'cterm': 240  }
" ???
let s:colors.base5 = { 'gui': '#599cab', 'cterm': 2  }
" text 244
let s:colors.base6 = { 'gui': '#000000', 'cterm': 234 }
" ???
