...
" Cut line off at the space before eighty characters
nnoremap <leader>tl :call CutLine()<cr>
...
function! LaTeXToPDF()
    ...
    let l:dvipdfm="dvipdfm " . l:filename . ".dvi"
